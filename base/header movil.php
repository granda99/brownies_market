        ...
        <div class="header__top">
            ...
            <div class="header__right">
                ...
                <ul class="navigation__extra">
                   ...
                   <li><i class="icon-telephone"></i> Teléfono:<strong> 0912345678</strong></li>    
					    ...
					    <div class="ps-filter__content">
					        ...
					        <aside class="widget widget_shop">
					          <ul class="ps-list--categories">
				                  <li class="current-menu-item "><a href="shop-default.html">Catálogo &amp; Moms</a>
				                  </li>
				                  <li class="current-menu-item "><a href="shop-default.html"> Sobre nosotros</a>
				                  </li>
				                  <li class="current-menu-item "><a href="shop-default.html">Contacto</a>
								  <li class="current-menu-item "><a href="shop-default.html">Más</a>
				                  </li>
					            </ul>
